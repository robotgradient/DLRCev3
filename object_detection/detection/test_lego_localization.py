...
while True:
	...
	just_for_size = np.array(BB_legos)
	...
	for box in BB_legos:
		...
		distance_x =  (-output_vector[0,0,0]+cam[0,0,0])*pixel_size +29
		distance_y = -(output_vector[0,0,1] - cam[0,0,1])*pixel_size

		angle = np.arctan2(distance_y,distance_x)*180/pi
	...
	#print(dst.shape)
	#cv2.rectangle(frame,(0,0),(200,300),(255,0,0))
